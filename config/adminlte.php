        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'  => 'Vat Settings',
                    'route' => 'settings-vat',
                    'icon'  => 'fas fa-fw fas fa-percentage',
                ],
                [
    ...
    */
    ...
    'plugins' => [
        ...
        'toastr'      => [
            'active' => true,
            'files'  => [
                [ 'type' => 'js', 'asset' => false, 'location' => 'https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js' ],
